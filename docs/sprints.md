...
| 3 | Prompt Viewer | Current-request snapshots by model round implemented; unit tests and Angular template compilation passed. Browser acceptance and full production build remain to verify. See prompt-viewer.md. |
| 4 | Chunk Viewer | Source preview exists; inspect remaining highlighting and detailed metadata requirements. |
